...
const STAT_DISPLAY_LABELS: Record<string, string> = {
  ...
  AllHeroMoveSpeed: 'Move Speed',
  HpRegenPerSec: 'HP Regen',
  AddHpPerKill: 'HP on Kill',
  AddHpPerHit: 'HP on Hit',
  HpLeech: 'Life Leech',
  BlockChance: 'Block Chance',
  DodgeChance: 'Dodge',
  MaxDodgeChance: 'Max Dodge',
  ElementalDodgeChance: 'Elem. Dodge',
  DamageReduction: 'Dmg Reduction',
  DamageAbsorption: 'Dmg Absorb',
  PhysicalDamagePercent: 'Physical Dmg',
  ColdDamagePercent: 'Cold Dmg',
  FireDamagePercent: 'Fire Dmg',
  LightningDamagePercent: 'Lightning Dmg',
  AllElementalResistance: 'Elem. Resist',
  AreaOfEffect: 'AoE',
  IncreaseAreaOfEffectDamage: 'AoE Dmg',
  IncreaseProjectileDamage: 'Proj. Dmg',
  SkillDurationIncrease: 'Duration',
  SkillHealIncrease: 'Heal Boost',
  SkillRangeExpansion: 'Range',
};
